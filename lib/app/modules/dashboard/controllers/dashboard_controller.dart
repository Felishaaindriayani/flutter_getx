...
import 'package:flutter_felisha/app/data/detail_event_response.dart';
import 'package:flutter_felisha/app/data/event_response.dart';
import 'package:flutter_felisha/app/modules/dashboard/views/index_view.dart';
import 'package:flutter_felisha/app/modules/dashboard/views/profile_view.dart';
import 'package:flutter/widgets.dart';
import 'package:flutter_felisha/app/modules/dashboard/views/your_event_view.dart';
import 'package:flutter_felisha/app/utils/api.dart';
...
class DashboardController extends GetxController {
  ...
  Future<DetailEventResponse> getDetailEvent({required int id}) async {
    final response = await _getConnect.get('${BaseUrl.detailEvents}/$id',
        headers: {'Authorization': "Bearer $token"},
        contentType: "application/json");
